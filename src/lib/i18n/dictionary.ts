/**
 * EN / AR translation tables.
 *
 * Generated once from the original `src/modules/i18n.js` so no string was
 * retyped. `TranslationKey` is derived from the English table, which makes a
 * missing or misspelled key a compile error at every call site.
 */
