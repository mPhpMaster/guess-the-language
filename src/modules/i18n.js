...
export const I18N = {
    en: {
        ...
        answeredTimeout: 'timeout · answer:',
        reportEntry: 'Report',
        ...
        hudCorrect: 'CORRECT',
        hudStreak: 'STREAK',
        answerWithKeys: 'press 1–{n} to answer',
        signedInDiscord: 'signed in · discord',
        tbRound: 'round',
        tbResults: 'results',
        tbLeaderboard: 'leaderboard —',
        tbLobby: 'lobby · room',
        tbProfile: 'profile —',
        railRank: 'rank',
        ...
        weeklyChallengeEmpty: 'No daily challenges played yet this week.',
