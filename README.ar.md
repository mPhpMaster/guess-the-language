...
للأصدقاء/عالمية. **الواجهة كاملة بالعربية والإنجليزية** (مع تخطيط RTL)، ويمكن التبديل
بينهما من القائمة.

![القائمة](screenshots/5-menu-ar.png)

| أثناء اللعب | شاشة النتائج |
| --- | --- |
| ![اللعب](screenshots/6-game-ar.png) | ![النتائج](screenshots/7-results-ar.png) |
