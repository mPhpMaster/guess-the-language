...
قابل للتثبيت) ولـ **Discord** (كنشاط مضمّن). من صفحة رئيسية واحدة تختار أحد ستة أنماط
...
- **🎲 الكل (مدمج)** — البنوك الخمسة معاً بترتيب عشوائي؛ يُعرض كل سؤال بنمط إجابته الخاص.
