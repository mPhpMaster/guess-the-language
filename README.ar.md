...
عالمية حيّة** لكل نمط (Supabase). **واجهة اللعبة بالإنجليزية.**
...
![اختيار النمط](screenshots/8-modeselect.png)

| نمط اللغات | نمط الأمن السيبراني |
| --- | --- |
| ![اللعب](screenshots/2-game.png) | ![سيبراني](screenshots/9-cyber-game.png) |

| شاشة النتائج | حول التطبيق |
| --- | --- |
| ![النتائج](screenshots/4-results.png) | ![حول](screenshots/12-about.png) |
...
واجهة اللعبة بالإنجليزية فقط. (هذا الملف توثيق للمطوّرين بالعربية، وليس جزءًا من
واجهة اللعبة.)
...
└─ test/
   ...
   ├─ smoke-i18n.js             # نصوص الواجهة الإنجليزية + ترحيل اللغة المخزّنة (11 فحصًا)
