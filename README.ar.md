...
ثلاثة أنماط، ثم تتسابق مع المؤقّت — مع نظام نقاط وسلاسل إجابات ولوحة صدارة لكل نمط.
...
- **🎲 الكل (مدمج)** — البنوك الأربعة معاً بترتيب عشوائي؛ يُعرض كل سؤال بنمط إجابته الخاص.
...
الناتج يوضع في مجلد `dist/` (مثل `Guess The Language Setup 2.3.0.exe`).
