...
- **🛡️ الأمن السيبراني** — أسئلة اختيار من متعدد عن الأدوات والبرمجيات الخبيثة وNmap
  وأعلامه وMetasploit وأدوات الاختبار (Wireshark, Burp, sqlmap, John, Hydra…) والمنافذ ومفاهيم الأمن.
- **🎲 الكل (مدمج)** — البنكان معاً بترتيب عشوائي؛ يُعرض كل سؤال بنمط إجابته الخاص.
